...
<main class="sign-up">
      <div class="sign-up__content">
        ...
        <form class="sign-up__form form" id='form_inst' name='form_inst' method='post' action='insertInstituicao2.php'>
          ...
          <div class="form__row">
            ...
            <input type='button' class="btn btn--regular" id="sign-up-button" tabindex="0" onclick='cadastroInst()' value='Cadastrar'><br><br>
